...
static func _level_g1_1() -> Dictionary:
	return {
		...
		"rule_description": "Conte quantas caixas estão nesta sala e coloque no espaço marcado a caixa com o número correspondente a esse total.",
		...
		"plates": [
			{"pos": Vector2i(6, 3), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 3, "label": "", "id": "p1"}
		],
...
static func _level_g1_2() -> Dictionary:
	return {
		...
		"rule_description": "Coloque cada caixa em sua vaga.",
		"rule_type": "TARGET_PLATES",
		"target_value": 2,
		"optimal_steps": 14,
		"grid_width": 9,
...
static func _level_g1_3() -> Dictionary:
	return {
		...
		"rule_description": "Compare as caixas disponíveis. Qual delas representa a MAIOR quantidade? Coloque a caixa escolhida no espaço demarcado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 5,
		"optimal_steps": 12,
		"grid_width": 9,
		...
		"status_format": "5 é maior que 2! Você escolheu a maior quantidade!"
	}
...
static func _level_g1_4() -> Dictionary:
	return {
		...
		"rule_description": "Na sequência de números de 1 a 3, qual número fica exatamente no meio (entre 1 e 3)? Coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 2,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g1_5() -> Dictionary:
	return {
		...
		"rule_description": "Organize as caixas nos três espaços em ordem crescente, partindo do menor para o maior.",
...
static func _level_g1_7() -> Dictionary:
	return {
		...
		"rule_description": "Seguindo a contagem 2, 3, 4... Qual é o próximo número (+1)? Coloque o número que vem a seguir no espaço vazio.",
		"rule_type": "TARGET_PLATES",
		"target_value": 5,
		"optimal_steps": 13,
		"grid_width": 9,
		...
		"plates": [
			{"pos": Vector2i(6, 3), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 5, "label": "Próximo número", "id": "p1"}
		],
...
static func _level_g1_8() -> Dictionary:
	return {
		...
		"rule_description": "Junte duas caixas nos espaços marcados que somadas atinjam exatamente a meta de 5 unidades.",
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Junte aqui", "id": "s1"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Junte aqui", "id": "s2"}
		],
...
static func _level_g1_9() -> Dictionary:
	return {
		...
		"rule_description": "Em uma brincadeira havia 5 blocos e 2 foram guardados. Quantos blocos restaram? Coloque a sobra no espaço indicado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 3,
		"optimal_steps": 14,
		"grid_width": 9,
...
static func _level_g1_10() -> Dictionary:
	return {
		...
		"rule_description": "Desafio final do 1º Ano: encontre o par de caixas que juntas somam 6 unidades para abrir o portão.",
		"rule_type": "SUM_EQUALS",
		"target_value": 6,
		"optimal_steps": 18,
		"grid_width": 10,
...
static func _level_g2_1() -> Dictionary:
	return {
		...
		"rule_description": "Organize as dezenas nos três espaços em ordem crescente (do menor para o maior).",
		"rule_type": "ORDER_ASCENDING",
		"target_value": 30,
		"optimal_steps": 18,
		"grid_width": 10,
...
static func _level_g2_2() -> Dictionary:
	return {
		...
		"rule_description": "O espaço exige um número MAIOR que 15 (> 15). Analise as opções e coloque a caixa adequada na vaga.",
...
static func _level_g2_3() -> Dictionary:
	return {
		...
		"rule_description": "Observe a reta numérica: 10, 20, [ ? ], 40. Descubra o número que falta e coloque-o na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 30,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g2_4() -> Dictionary:
	return {
		...
		"rule_description": "Componha o número 25 colocando dezenas inteiras e unidades nos espaços indicados.",
		"rule_type": "SUM_EQUALS",
		"target_value": 25,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g2_5() -> Dictionary:
	return {
		...
		"rule_description": "Descubra quais duas caixas somadas alcançam exatamente a meta de 15 unidades e coloque-as nos espaços marcados.",
		"rule_type": "SUM_EQUALS",
		"target_value": 15,
		"optimal_steps": 16,
		"grid_width": 9,
...
static func _level_g2_6() -> Dictionary:
	return {
		...
		"rule_description": "Você já tem 6 pontos e precisa alcançar a meta de 14. Quantos pontos faltam para completar? Coloque a diferença no local marcado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 8,
		"optimal_steps": 14,
		"grid_width": 9,
...
static func _level_g2_7() -> Dictionary:
	return {
		...
		"rule_description": "Encontre o par de caixas que juntas somam exatamente uma centena inteira (100) e coloque-as nos espaços demarcados.",
		"rule_type": "SUM_EQUALS",
		"target_value": 100,
		"optimal_steps": 17,
		"grid_width": 10,
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Junte aqui", "id": "p1"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Junte aqui", "id": "p2"}
		],
...
static func _level_g2_8() -> Dictionary:
	return {
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.EVEN, "val": 0, "label": "Vaga PAR", "id": "p_even"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ODD, "val": 0, "label": "Vaga ÍMPAR", "id": "p_odd"}
		],
...
static func _level_g2_9() -> Dictionary:
	return {
		...
		"rule_description": "Observe a sequência de saltos: 5, 10, 15, [ ? ]. Encontre o próximo número e coloque-o na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 20,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g2_10() -> Dictionary:
	return {
		...
		"rule_description": "Na gincana escolar, a turma marcou 12 pontos pela manhã e 8 pontos à tarde. Coloque os dois valores nos espaços para totalizar a pontuação.",
		"rule_type": "SUM_EQUALS",
		"target_value": 20,
		"optimal_steps": 18,
		"grid_width": 10,
...
static func _level_g3_1() -> Dictionary:
	return {
		...
		"rule_description": "Encontre duas caixas que, somadas por decomposição, atinjam exatamente a meta de 40 unidades e coloque-as nos espaços marcados.",
		"rule_type": "SUM_EQUALS",
		"target_value": 40,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g3_2() -> Dictionary:
	return {
		...
		"rule_description": "Um feirante tinha 50 caixas de frutas no estoque e vendeu 18 pela manhã. Quantas caixas restaram? Coloque o resultado no local indicado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 32,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g3_3() -> Dictionary:
	return {
		...
		"rule_description": "Você tem 3 grupos contendo 4 caixas cada um (4 + 4 + 4). Coloque os dois fatores nos espaços para calcular o produto total.",
		...
		"plates": [
			...
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Itens por grupo", "id": "p2"}
		],
...
static func _level_g3_4() -> Dictionary:
	return {
		...
		"rule_description": "Uma horta possui 3 fileiras com 5 canteiros cada. Coloque as caixas correspondentes às linhas e colunas nos locais marcados para calcular o total.",
		"rule_type": "MULTIPLICATION",
		"target_value": 15,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g3_5() -> Dictionary:
	return {
		...
		"rule_description": "Descubra qual par de fatores produz exatamente o valor 20 e coloque as duas caixas nos espaços indicados.",
		"rule_type": "MULTIPLICATION",
		"target_value": 20,
		"optimal_steps": 17,
		"grid_width": 10,
...
static func _level_g3_6() -> Dictionary:
	return {
		...
		"rule_description": "18 figurinhas foram divididas igualmente entre 3 amigos. Quantas figurinhas cada amigo recebeu? Coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 6,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g3_7() -> Dictionary:
	return {
		...
		"rule_description": "Quantos grupos completos de 4 alunos podem ser formados em uma turma com 24 alunos? Coloque a resposta no local indicado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 6,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g3_8() -> Dictionary:
	return {
		...
		"rule_description": "Calcule a metade de 16 e a terça parte (1/3) de 15. Coloque as respostas correspondentes em cada espaço marcado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 0,
		"optimal_steps": 17,
		"grid_width": 10,
...
static func _level_g3_9() -> Dictionary:
	return {
		...
		"rule_description": "Identifique o padrão de saltos regulares 4, 8, 12... e complete a sequência colocando os dois próximos números nos locais marcados.",
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 16, "label": "4º número (+4)", "id": "p1"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 20, "label": "5º número (+4)", "id": "p2"}
		],
...
static func _level_g3_10() -> Dictionary:
	return {
		...
		"rule_description": "Uma papelaria vende estojos por 4 moedas cada. Uma escola comprou 6 estojos. Coloque os fatores nos espaços para calcular o custo total.",
		"rule_type": "MULTIPLICATION",
		"target_value": 24,
		"optimal_steps": 17,
		"grid_width": 10,
		...
		"plates": [
			...
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Preço por estojo", "id": "p2"}
		],
...
static func _level_g4_1() -> Dictionary:
	return {
		...
		"rule_description": "Uma campanha arrecadou 150 kg de mantimentos no sábado e 250 kg no domingo. Coloque os valores nos locais indicados para calcular a soma total.",
		"rule_type": "SUM_EQUALS",
		"target_value": 400,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g4_2() -> Dictionary:
	return {
		...
		"rule_description": "8 vans escolares transportam exatamente 6 estudantes cada uma. Coloque os fatores nos espaços para calcular o total de passageiros.",
		"rule_type": "MULTIPLICATION",
		"target_value": 48,
		"optimal_steps": 16,
		"grid_width": 10,
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Vans", "id": "p1"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Alunos por van", "id": "p2"}
		],
...
static func _level_g4_3() -> Dictionary:
	return {
		...
		"rule_description": "15 livros foram embalados em pacotes de 4 unidades cada. Quantos livros SOBRARAM no resto da divisão? Coloque a sobra na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 3,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g4_4() -> Dictionary:
	return {
		...
		"rule_description": "Sabendo que 7 x 6 = 42, use a operação inversa para determinar quanto é 42 ÷ 6 e coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 7,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g4_5() -> Dictionary:
	return {
		...
		"rule_description": "Descubra qual par de caixas, quando multiplicadas, atinge exatamente a meta de 100 e coloque-as nos espaços demarcados.",
		"rule_type": "MULTIPLICATION",
		"target_value": 100,
		"optimal_steps": 17,
		"grid_width": 10,
...
static func _level_g4_6() -> Dictionary:
	return {
		...
		"rule_description": "Uma torta inteira foi dividida em 8 fatias iguais. Quantas fatias correspondem a 1/4 da torta? Coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 2,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g4_7() -> Dictionary:
	return {
		...
		"rule_description": "Calcule o perímetro (medida do contorno) de um canteiro retangular de 4 metros por 3 metros. Coloque a medida total no espaço indicado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 14,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g4_8() -> Dictionary:
	return {
		...
		"rule_description": "Uma sala retangular ocupa 5 quadradinhos de largura por 3 quadradinhos de altura na malha. Calcule a área total e coloque o resultado na vaga marcada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 15,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g4_9() -> Dictionary:
	return {
		...
		"rule_description": "O placar indica que o Time A marcou 18 pontos e o Time B marcou 12 pontos. Quantos pontos a mais fez o Time A? Coloque a diferença no local indicado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 6,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g4_10() -> Dictionary:
	return {
		...
		"rule_description": "Uma quadra esportiva quadrada tem 4 lados iguais medindo 6 metros cada. Coloque a quantidade de lados e a medida nos espaços para calcular o perímetro total.",
		"rule_type": "MULTIPLICATION",
		"target_value": 24,
		"optimal_steps": 17,
		"grid_width": 10,
		...
		"plates": [
			...
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Metros por lado", "id": "p2"}
		],
...
static func _level_g5_1() -> Dictionary:
	return {
		...
		"rule_description": "Componha o número 345 colocando a centena e a soma de dezenas com unidades nos espaços indicados.",
		"rule_type": "SUM_EQUALS",
		"target_value": 345,
		"optimal_steps": 16,
		"grid_width": 10,
		...
		"plates": [
			{"pos": Vector2i(6, 2), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Centenas", "id": "p1"},
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Dezenas e Unidades", "id": "p2"}
		],
...
static func _level_g5_2() -> Dictionary:
	return {
		...
		"rule_description": "Uma caixa contém 20 bombons no total. Encontre a quantidade equivalente a 3/4 desse total e coloque a caixa na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 15,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g5_3() -> Dictionary:
	return {
		...
		"rule_description": "Em uma barra dividida em 8 pedaços iguais, compare as frações 1/2 e 1/4. Descubra quantos pedaços possui a MAIOR dessas frações e coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 4,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g5_4() -> Dictionary:
	return {
		...
		"rule_description": "Uma barra de chocolate tem 12 pedaços. Encontre a quantidade de pedaços correspondente à fração equivalente a 2/4 (metade) e coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 6,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g5_5() -> Dictionary:
	return {
		...
		"rule_description": "Você comprou um lanche de R$ 2,50 e um suco de R$ 1,50. Coloque os valores em centavos de cada item nos espaços para totalizar a conta.",
		"rule_type": "SUM_EQUALS",
		"target_value": 400,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g5_6() -> Dictionary:
	return {
		...
		"rule_description": "Você fez uma compra de R$ 6,50 e pagou com uma nota de R$ 10,00. Calcule o troco exato (em centavos) e coloque a resposta na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 350,
		"optimal_steps": 15,
		"grid_width": 10,
...
static func _level_g5_7() -> Dictionary:
	return {
		...
		"rule_description": "Uma loja oferece 50% de desconto em um livro que custa R$ 60,00. Calcule o valor em reais do desconto e coloque a resposta no local marcado.",
		"rule_type": "TARGET_PLATES",
		"target_value": 30,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_g5_8() -> Dictionary:
	return {
		...
		"rule_description": "Se 1 pacote contém 5 figurinhas, quantas figurinhas haverá em 6 pacotes? Coloque os valores nos espaços para calcular a proporção.",
		"rule_type": "MULTIPLICATION",
		"target_value": 30,
		"optimal_steps": 16,
		"grid_width": 10,
		...
		"plates": [
			...
			{"pos": Vector2i(6, 4), "type": SokoPlate.ConditionType.ANY_VALUE, "val": 0, "label": "Figurinhas por pct", "id": "p2"}
		],
...
static func _level_g5_9() -> Dictionary:
	return {
		...
		"rule_description": "Um pátio escolar mede 6 metros de comprimento por 2 metros de largura. Coloque as medidas das dimensões nos espaços marcados para calcular a área total.",
		"rule_type": "MULTIPLICATION",
		"target_value": 12,
		"optimal_steps": 16,
		"grid_width": 10,
...
static func _level_g5_10() -> Dictionary:
	return {
		...
		"rule_description": "Uma pesquisa registrou 12 votos na segunda-feira e o dobro desse valor na terça-feira. Coloque as duas quantidades nos espaços indicados para totalizar os votos.",
		"rule_type": "SUM_EQUALS",
		"target_value": 36,
		"optimal_steps": 18,
		"grid_width": 10,
...
static func _level_extra_1() -> Dictionary:
	return {
		...
		"rule_description": "Planeje a sequência correta de empurrões para guiar a caixa pelo corredor estreito até a vaga final sem encurralá-la.",
		"rule_type": "TARGET_PLATES",
		"target_value": 1,
		"optimal_steps": 12,
		"grid_width": 9,
		...
		"plates": [
			{"pos": Vector2i(6, 3), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 1, "label": "Vaga Final", "id": "p1"}
		],
...
static func _level_extra_2() -> Dictionary:
	return {
		...
		"rule_description": "Descubra a regularidade da sequência lógica: 3, 6, 9, [ ? ]. Encontre o próximo número e coloque-o na vaga indicada.",
		"rule_type": "TARGET_PLATES",
		"target_value": 12,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_extra_3() -> Dictionary:
	return {
		...
		"rule_description": "Navegue pelo labirinto e manobre as duas caixas pelas curvas até colocá-las em seus nichos de destino.",
		"rule_type": "TARGET_PLATES",
		"target_value": 0,
		"optimal_steps": 18,
		"grid_width": 10,
...
static func _level_extra_5() -> Dictionary:
	return {
		...
		"rule_description": "Circuito E (AND): o portal só abre quando AMBAS as vagas de entrada estiverem ativadas com o número 1 ao mesmo tempo.",
...
static func _level_extra_6() -> Dictionary:
	return {
		...
		"rule_description": "Circuito OU (OR): basta preencher pelo menos UMA das vagas de entrada com o número 1 para abrir a passagem.",
		"rule_type": "LOGIC_OR",
		"target_value": 1,
		"optimal_steps": 14,
		"grid_width": 10,
...
static func _level_extra_7() -> Dictionary:
	return {
		...
		"plates": [
			{"pos": Vector2i(7, 3), "type": SokoPlate.ConditionType.TARGET_VALUE, "val": 12, "label": "Par e > 10", "id": "p1"}
		],
...
static func _level_extra_8() -> Dictionary:
	return {
		...
		"rule_description": "A vaga requer um número PAR para destravar o caminho, mas uma caixa ímpar está na frente. Identifique a caixa par correta e coloque-a no local indicado.",
		"rule_type": "CONDITION_SINGLE",
		"target_value": 0,
		"optimal_steps": 15,
		"grid_width": 10,
		...
		"plates": [
			{"pos": Vector2i(7, 3), "type": SokoPlate.ConditionType.EVEN, "val": 0, "label": "Vaga Par", "id": "p1"}
		],
		"status_format": "Falha depurada! Caixa par (6) ativou a vaga com sucesso!"
	}
...
static func _level_extra_9() -> Dictionary:
	return {
		...
		"rule_description": "Circuito combinado: conecte as duas caixas lógicas nas chaves de entrada para acionar a saída.",
		"rule_type": "LOGIC_CIRCUIT",
		"target_value": 1,
		"optimal_steps": 17,
		"grid_width": 10,
...
static func _level_extra_10() -> Dictionary:
	return {
		...
		"rule_description": "Desafio Mestre: organize as caixas nos alvos na ordem crescente das estações (1ª -> 2ª -> 3ª) sem obstruir corredores.",
		"rule_type": "ORDER_ASCENDING",
		"target_value": 3,
		"optimal_steps": 22,
		"grid_width": 11,
